class Ambience {
  ...
  fan: { source: AudioBufferSourceNode; filter: BiquadFilterNode; gain: GainNode } | null = null;
  hum: OscillatorNode | null = null;
  tape: { source: AudioBufferSourceNode; filter: BiquadFilterNode; gain: GainNode } | null = null;
  tapeWind: { source: AudioBufferSourceNode; filter: BiquadFilterNode; gain: GainNode } | null = null;
  ...
  loopNoise(filterType: BiquadFilterType, frequency: number, gainValue: number, q = 1) {
