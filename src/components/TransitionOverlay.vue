...
.transition-subtitle.narration .transition-kind { color: #493f32; }
...
.transition-subtitle.narration .transition-text { color: #11100d; text-shadow: 0 1px 1px #fff8; }
.transition-subtitle.thought .transition-text   { color: #2e8b57; text-shadow: 0 1px 1px #eaffee; }
...
.transition-reveal.visible { opacity: 1; }
